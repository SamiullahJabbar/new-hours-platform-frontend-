...
const ManageTips = () => {
    ...
    return (
        <section className='manage-tips p-5' id='manage-tips'>

            {/* Header */}
            <div className="flex items-center justify-between mb-6">
                <div>
                    <h1 className="text-xl font-semibold text-gray-800">Admin Dashboard</h1>
                    <p className="text-gray-500 mt-1">Manage Tips</p>
                </div>
                <div>
                    ...
                    <button className='inline-block px-5 py-2 font-medium bg-gray-900 transition-colors hover:bg-gray-800 text-white rounded-md' type="button">Add New Tip</button>
                </div>
            </div>
